...
<form class="variations_form cart" method="post" enctype='multipart/form-data'
	...
	data-product_variations="<?php echo $variations_attr; ?>" data-wccl="true">
				...
				<tr>
					...
					<td class="value">
						<select id="<?php echo esc_attr( sanitize_title( $name ) ); ?>"
							...
							data-type="<?php echo $attributes_types[ $name ] ?>">
							...
							if ( ! empty( $options ) ) {
								...
								if ( $product && taxonomy_exists( $name ) ) {
									...
									foreach ( $terms as $term ) {
										...
										echo '<option value="' . esc_attr( $term->slug ) . '" ' . selected( sanitize_title( $selected_value ), sanitize_title( $term->slug ), false ) . ' data-value="' . $value . '">' . esc_html( apply_filters( 'woocommerce_variation_option_name', $term->name ) ) . '</option>';
									}
