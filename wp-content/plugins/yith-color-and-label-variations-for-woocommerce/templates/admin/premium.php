	...
	<div class="seven section section-even clear">
		<div class="landing-container">
			...
			<div class="col-2">
				...
				<p>
					<?php echo sprintf( esc_html__( 'The admin can add a unique image gallery for each product variation. Showing the customer all different looks of the product, in the color of their choice. 
', 'yith-color-and-label-variations-for-woocommerce' ), '<b>', '</b>', '<br>' ); ?>
				</p>
			</div>
		</div>
	</div>
