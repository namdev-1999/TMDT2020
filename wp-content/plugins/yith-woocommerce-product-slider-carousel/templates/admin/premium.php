...
<div class="section section-cta section-odd">
    <div class="landing-container">
        <div class="premium-cta">
            <p>
                <?php echo sprintf( __('Upgrade to %1$spremium version%2$s of %1$sYITH WooCommerce Product Slider Carousel%2$s to benefit from all features!','yith-woocommerce-product-slider-carousel'),'<span class="highlight">','</span>' );?>
            </p>
            <a href="<?php echo $premium_landing_uri;?>" target="_blank" class="premium-cta-button button btn">
                <span class="highlight"><?php _e('UPGRADE','yith-woocommerce-product-slider-carousel');?></span>
                <span><?php _e('to the premium version','yith-woocommerce-product-slider-carousel');?></span>
            </a>
        </div>
    </div>
</div>
<div class="section section-even clear" style="background: url(<?php echo YWCPS_URL ?>assets/images/01-bg.png) no-repeat #fff; background-position: 85% 75%">
    <h1><?PHP _E('Premium Features','yith-woocommerce-product-slider-carousel');?></h1>
    <div class="landing-container">
        <div class="col-1">
        ...
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?PHP _e('Tailor-made responsivity ','yith-woocommerce-product-slider-carousel');?></h2>
            </div>
            <p>
                ...
                ', 'yith-woocommerce-product-slider-carousel'), '<b>', '</b>');?>
            </p>
        </div>
    </div>
</div>
    ...
    <div class="landing-container">
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?php _e('Unlimited sliders','yith-woocommerce-product-slider-carousel');?></h2>
            </div>
            <p>
                <?php _e( 'No restrictions to the number of sliders available. You will be able to create as many as you want to make products in your shop slide in your site pages','yith-woocommerce-product-slider-carousel' );?></p>
        </div>
        <div class="col-1">
    ...
    <div class="landing-container">
        ...
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?php _e( 'Product types','yith-woocommerce-product-slider-carousel');?></h2>
            </div>
            <p><?php _e('Enjoy the possibility to show different product for each slider!
                If you did not want to show all products of your shop, you can select only some of them, according to the following selection criteria:','yith-woocommerce-product-slider-carousel');?>
            </p>
            <ul>
                <li><?php _e('“on sale” products','yith-woocommerce-product-slider-carousel'); ?></li>
                <li><?php _e('most purchased products','yith-woocommerce-product-slider-carousel'); ?></li>
                <li><?php _e( 'free products','yith-woocommerce-product-slider-carousel' ); ?></li>
                <li><?php _e('featured products','yith-woocommerce-product-slider-carousel'); ?></li>
                <li><?php _e( 'most recent products','yith-woocommerce-product-slider-carousel' ); ?></li>
                <li><?php _e( 'products with a specific ID (any product you want to show)','yith-woocommerce-product-slider-carousel' ); ?></li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="landing-container">
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?php _e('Template layout','yith-woocommerce-product-slider-carousel');?></h2>
            </div>
            <p>
                ...
                be able to create %1$sthree different layout%2$s templates and use them for sliders in your shop.','yith-woocommerce-product-slider-carousel' ),'<b>','</b>' );?>
            </p>
        </div>
        <div class="col-1">
    ...
    <div class="landing-container">
        ...
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?php _e('Hide price and “Add to cart” button','yith-woocommerce-product-slider-carousel');?></h2>
            </div>
            <p>
                <?php echo sprintf( __('Choose to show or hide price and/or “Add to cart” button for products shown in your slider.
                 Two tailor-made options that you can directly control from plugin option panel.','yith-woocommerce-product-slider-carousel'),'<b>','</b>' );?></p>
        </div>
    </div>
</div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Widget','yith-woocommerce-product-slider-carousel');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __( 'Add your sliders in sidebars using the widget “YITH WooCommerce Product Slider Carousel”. Don’t leave anything to chance.','yith-woocommerce-product-slider-carousel' ),'<b>','</b>' );?>
                </p>
            </div>
            <div class="col-1">
