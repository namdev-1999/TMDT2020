...
if ( ! class_exists( 'YITH_WooCommerce_Order_Tracking_Premium' ) ) {
    ...
    class YITH_WooCommerce_Order_Tracking_Premium extends YITH_WooCommerce_Order_Tracking {
        ...
        public function set_picked_order_to_completed( $order ) {
            ...
            $desired_order_status = apply_filters( 'ywot_picked_order_new_status', 'completed', $order );
            if ( ! in_array( $current_status, $unavailable_order_status ) ) {
                $order->update_status( $desired_order_status,
        ...
        function show_tracking_information( $order, $pattern, $prefix = '', $output = 'frontend' ) {
	        ...
	        if ( apply_filters( 'yith_ywot_block_email_message', false, $order_id ) ) {
		        return '';
	        }
        ...
        public function register_email_order_tracking_actions() {
            if ( ! isset( $this->mail_text_position ) || ( 1 == $this->mail_text_position ) ) {
                add_action( 'woocommerce_email_before_order_table', array( $this, 'add_email_shipping_details' ), 10, 4 );
            } else {
                add_action( 'woocommerce_email_after_order_table', array( $this, 'add_email_shipping_details' ), 10, 4 );
            }
        }
         ...
         * @return void
         */
        function add_email_shipping_details( $order, $sent_to_admin, $plain_text, $email ) {
            ...
            if ( in_array( $email->id, $refund_emails ) ) {
            	return;
            }
        ...
        public function action_links( $links ) {
            $links = yith_add_action_links( $links, $this->_panel_page, true, YITH_YWOT_SLUG );
            return $links;
        }
