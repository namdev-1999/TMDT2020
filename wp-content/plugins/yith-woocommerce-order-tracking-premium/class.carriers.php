	...
	class Carriers {
		...
		public function get_carrier_list() {
			$carriers = array(
				...
				'ACIEXPRESS'       => array(
					'name'      => 'Aci Express',
					'track_url' => 'https://acieshop.com/pod.php?OrderNo=[TRACK_CODE]',
				),
				'AFL'               => array(
...
//				),
				...
				'INDIA_POST'        => array(
					...
					'track_url' => 'https://www.indiapost.gov.in/_layouts/15/DOP.Portal.Tracking/TrackConsignment.aspx',
				),
				'INTERLINK'         => array(
				...
				'LAPOSTE'           => array(
					'name'      => 'La Poste',
					'track_url' => 'https://www.laposte.fr/outils/suivre-vos-envois?code=[TRACK_CODE]',
				),
				'LASERSHIP'         => array(
					'name'      => 'LaserShip',
				...
				'SINGAPORE_POST'    => array(
					'name'      => 'Singapore POST',
					'track_url' => 'https://www.tracking.my/singpost/[TRACK_CODE]',
...
//					'track_url' => 'http://www.correos.es/ss/Satellite/site/pagina-localizador_referencia_expedicion/sidioma=en_GB&Referencia=[TRACK_CODE]',
				...
				'SAGAWA_EX'         => array(
					'name'      => 'SAGAWA EXPRESS',
					'track_url' => 'https://k2k.sagawa-exp.co.jp/p/sagawa/web/okurijoinput.jsp',
				),
				'TOLLGROUP'         => array(
				...
				'COLISSIMO'         => array(
					'name'      => 'COLISSIMO',
					'track_url' => 'https://track.aftership.com/trackings?courier=colissimo&language=en&tracking-numbers=[TRACK_CODE]',
					'form'      => '',
				),
				'SHIPYAARI'         => array(
					'name'      => 'Shipyaari',
				...
				'OCA'               => array(
					'name'      => 'OCA',
					'track_url' => 'https://www.oca.com.ar/envios/paquetes/[TRACK_CODE]/',
				),
				'CORREO_ARG'        => array(
				...
				'SF_EXPRESS_ENG'        => array(
					'name'      => 'SF Express ENG',
					'track_url' => 'https://www.sf-express.com/cn/en/dynamic_function/waybill/#search/bill-number/[TRACK_CODE]',
				),
				'SMSA_EXPRESS'      => array(
					'name'      => 'SMSA Express',
				...
				'FERCAM'         => array(
					'name'      => 'Fercam',
					'track_url' => 'https://www.fercam.com/it/contatti/contattaci-507.html',
				),
                'ALASKA_AIR'         => array(
                    'name'      => 'Alaska Air',
                ...
                'EVERTS_AIR'         => array(
                    'name'      => 'Everts Air',
                    'track_url' => 'https://apps1.tflite.com/Public/EVT/Freight/Tracking/[TRACK_CODE]',
                ),
                'LICCARDI'         => array(
                    'name'      => 'Liccardi',
				...
				'ITALGLO_DELIVERY' => array(
					...
					'track_url' => 'https://bialetti.pe/seguimiento-de-pedido/',
				),
				'STARKEN_CHILE' => array(
					'name'      => 'Starken',
				...
				'TWS_EXPRESS' => array(
					'name' => 'TWS Express',
					'track_url' => 'https://www.mytws.it/tracking-status;ldv=[TRACK_CODE]'
				),
				'TRAKPAK' => array(
					'name' => 'TRAKPAK',
					'track_url' => 'http://www.search.trackmytrakpak.com/?MyTrakPakNumber=[TRACK_CODE]'
				),
				'CORREOSCHILE' => array(
					'name' => 'CORREOS CHILE',
					'track_url' => 'https://www.correos.cl/web/guest/seguimiento-en-linea?codigos=[TRACK_CODE]',
				),
				'DHL_COLOMBIA' => array(
					'name'      => 'DHL Colombia',
					'track_url' => 'https://www.dhl.com/co-es/home/tracking/tracking-express.html?submit=1&tracking-id=[TRACK_CODE]',
				),
				'POSTI' => array(
					'name'      => 'Posti',
					'track_url' => 'https://www.posti.fi/fi/seuranta#/lahetys/[TRACK_CODE]',
				),
				'SHADOWFAX' => array(
					'name'      => 'Shadowfax',
					'track_url' => 'https://tracker.shadowfax.in',
				),
				'EKART' => array(
					'name'      => 'Ekart',
					'track_url' => 'https://ekartlogistics.com/',
				),
				'GO_PARCEL' => array(
					'name'      => 'Go Parcel NL',
					'track_url' => 'https://goparcel.nl/',
				),
				'PAKKETDIENST_QLS' => array(
					'name'      => 'Pakketdienst QLS NL',
					'track_url' => 'https://mijn.pakketdienstqls.nl/',
				),
				'CRONONLINE' => array(
					'name'      => 'CRONONLINE',
					'track_url' => 'https://www.crononline.it/wps/portal',
				),
				'BORDER_EXPRESS' => array(
					'name'      => 'Border Express',
					'track_url' => 'https://www.borderexpress.com.au/tracking/?cn=[TRACK_CODE]',
				),
				'GLS_Tracking_Austria' => array(
					'name'      => 'GLS Austria',
					'track_url' => 'https://gls-group.eu/AT/de/paket-verfolgen.html?match=[TRACK_CODE]',
				),
				'INTERTOWN' => array(
					'name'      => 'InterTown Transport',
					'track_url' => 'http://tracking.parcelperfect.com/2500.2401.2809/',
				),
				'SMYB' => array(
					'name'      => 'Smyb',
					'track_url' => ' https://smyb.htg.it/l64/E/ADSL/SMYB/%23XSH/%23%40SPE.IDF.Q02%23%23?P01=[TRACK_CODE]',
				),
			);
