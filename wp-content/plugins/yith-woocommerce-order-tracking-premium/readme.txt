...
= 1.6.9 - Released on 30 October 2020 =

* New: Support for WordPress 5.6
* New: Support for WooCommerce 4.7
* New: added new carrier Border Express
* New: added new carrier GLS Austria
* New: added new carrier Inter Town
* New: added new carrier Smyb
* New: Possibility to update plugin via WP-CLI
* Update: plugin framework
* Update: updated La Poste tracking link
* Update: Updated COLISSIMO link
* Update: Updated Singapore Post link
* Dev: added TRACK_CODE parameter to La Poste tracking link
* Dev: new filter ywot_picked_order_new_status

= 1.6.8 - Released on 01 October 2020 =

* New: Support for WooCommerce 4.6
* New: added new carrier Go Parcel NL
* New: added new carrier Pakketdienst QLS NL
* New: added new carrier CRONONLINE
* Tweak Sagawa Express link to Japanese
* Update: plugin framework
* Update: updated Fercam tracking link

= 1.6.7 - Released on 17 September 2020 =

* New: Support for WooCommerce 4.5
* New: added new carrier Shadowfax
* New: added new carrier Ekart
* New: added new carrier Posti
* New: added new carrier SF Express ENG
* Update: plugin fw
* Update: updated INDIA POST tracking link
* Update: updated Everts Air tracking link
* Dev: added new filter yith_ywot_block_email_message
* Dev: avoid include tracking details in refunded order email

= 1.6.6 - Released on 11 August 2020 =

* New: Support for WooCommerce 4.4
* New: Support for WordPress 5.5
* New: added new carrier Aci Express courier
* New: added new carrier TWS Express
* New: added new carrier TRAKPAK
* New: added new carrier CORREOSCHILE
* New: added new carrier DHL Colombia
* Update: plugin-fw
* Update: updated OCA tracking URL
